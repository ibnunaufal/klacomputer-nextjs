    ...
    <>
      <section className="relative z-10 py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="KLA Computer"
            paragraph="Dengan lebih dari 2 dekade pengalaman, kami siap membantu segala jenis kebutuhan teknologi anda mulai dari Laptop, PC, Printer, Mouse, Keyboard, dan Aksesoris lainnya."
            center
            mb="40px"
          />
        </div>
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[770px] overflow-hidden rounded-md">
                <div className="relative aspect-77/40 items-center justify-center">
                  <Image
                    src="/images/klacomputer/about-6.webp"
                    alt="video image"
